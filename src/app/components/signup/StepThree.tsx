        ...
        <React.Fragment>
            ...
            <div className="w-96 flex justify-between mt-6">
                <button
                    ...
                    className="bg-white px-6 py-2 font-semibold border-2 border-bg-main text-blue-500 rounded-md text-lg"
                >
                    Back
                </button>

                {
                    signingupProgress ? (<button disabled type="button" className="bg-main px-6 py-2 font-semibold border-2 border-bg-main text-white rounded-md text-lg text-center ">
                        ...
                        <button
                            onClick={skipPhone}
                            className="bg-main px-6 py-2 font-semibold border-2 border-bg-main text-white rounded-md text-lg"
                        >
                            Skip
                        </button>
                    ) : (
