...
const TESTIMONIALS = [
  {
    ...
    quote:
      "WorkResume's auto format feature is a tremendous help in maintaining a consistent and professional resume format. As an educator, I often see students making silly mistakes with inconsistent bullet points or font sizes. WorkResume eliminates these errors and ensures a polished resume.",
    name: "Ms. Spiegel",
    title: "Educator",
  },
  {
    ...
    quote:
      "During my last job search, I utilized WorkResume and received interview invitations from top tech companies like Google and Amazon. Thanks to its sleek and professional resume design, I was able to showcase my skills effectively and stand out from the competition.",
    name: "Santi",
  ...
  },
  {
    ...
    quote:
      "WorkResume provides a smooth and effortless experience for creating a professional resume. It saves me significant time and eliminates the frustration of dealing with Google Docs templates. Thanks to WorkResume, crafting a standout resume is simple and stress-free.",
    name: "Vivian",
