const STEPS = [
  { title: "Upload a resume PDF ", text: "or build one from scratch" },
  { title: "Preview your design", text: "Customize your resume" },
  { title: "Download your resume", text: "Feel confident and apply for jobs" },
];
export const Steps = () => {
  return (
